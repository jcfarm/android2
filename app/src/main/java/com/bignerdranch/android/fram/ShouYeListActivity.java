...
public class ShouYeListActivity extends AppCompatActivity {
    ...
    private String urlAdress = "http://192.168.0.102:8080/1.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager = (ViewPager)findViewById(R.id.front_view_pager);
        ...
        status_View = LayoutInflater.from(this).inflate(R.layout.fragment_status,null);
        control_View = LayoutInflater.from(this).inflate(R.layout.fragment_front_control,null);
            ...
            public void run() {
                ...
                try {
                    ...
                    if(httpURLConnection.getResponseCode() == 200){
                        ...
                        JSONArray texture = object.getJSONArray("wen");
                        for(int i =0;i<texture.length();i++){
                            /***********************/
                            Log.d(i+"", object.getString("one"));
                        }
                        Log.d("name",object.getString("name"));
                        Log.d("age",object.getString("age"+""));
                        JSONObject o = object.getJSONObject("address");
                        Log.d("country",object.getString("country"));
                        Log.d("province",object.getString("province"));
            ...
            public void run() {
                ...
                try {
                    ...
                    if(httpURLConnection.getResponseCode() ==200){
                        ...
                        bufferedReader.close();
                        httpURLConnection.disconnect();
                        Log.d("get",stringBuffer.toString());
                    }
                } catch (MalformedURLException e) {
                    e.printStackTrace();
                }catch (IOException e){
